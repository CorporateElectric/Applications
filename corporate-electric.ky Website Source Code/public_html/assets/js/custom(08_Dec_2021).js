...
var formContainer1 = $('#form-container1');
var formContainer2 = $('#form-container2');
...
function bindFormClick1() {

    $(formContainer1).on('click', function (e) {
        //alert('cscsc');
        e.preventDefault();
        toggleForm();
        //Ensure container doesn't togleForm when open
...
function bindFormClick2() {

    $(formContainer2).on('click', function (e) {
        //alert('cscsc');
        e.preventDefault();
        toggleForm();
        //Ensure container doesn't togleForm when open
