    ...
    return {
        ...
        fillFormObj: function () {
            ...
            $('.section-item').each(function () {
                ...
                if ($(this).hasClass('img-rt-area')) {
                ...
                else if ($(this).hasClass('services-img-rt-area')) {
                    ...
                    var title = $(this).find('.imgip').data('title');

                    var sub_title = $(this).find('.imgip').data('sub_title');

                    var shortdescription = $(this).find('.imgip').data('shortdescription');
                ...
                else if ($(this).hasClass('general-contact-info-img-rt-area')) {
                    ...
                    var title2 = $(this).find('.imgip').data('title2');
                    ...
                    var title3 = $(this).find('.imgip').data('title3');

                    var ph_no = $(this).find('.imgip').data('ph_no');

                    var ph_no2 = $(this).find('.imgip').data('ph_no2');

                

                    var title4 = $(this).find('.imgip').data('title4');

                    var title5 = $(this).find('.imgip').data('title5');

                    var buttontitle2 = $(this).find('.imgip').data('buttontitle2');

                    var buttonlink2 = $(this).find('.imgip').data('buttonlink2');
                ...
                if ($(this).hasClass('separate-img-rt-area')) {
                ...
                if ($(this).hasClass('add-on-img-rt-area')) {
                    ...
                    var title_client = $(this).find('.imgip').data('title_client');

                    var client_counter = $(this).find('.imgip').data('client_counter');
...
//                        var txt = $('.two_col_2').closest('div[data-editor=' + editior + ']').find('.onlytitleclass').val();
                    ...
                    var section_description = $(this).find('input[type=hidden]').data('section_description');
                ...
                } else if ($(this).hasClass('popularTemplate')) {
                ...
                } else if ($(this).hasClass('otherserviceTemplate')) {
                ...
                // 24-11-2021 Add On Services Start Code

                else if ($(this).hasClass('addonserviceTemplate')) {
                ...
                // 24-11-2021 Add On Services End Code
                ...
                } else if ($(this).hasClass('ourclientTemplate')) {
                    ...
                    var sectiondesc = $(this).find('.txtip').data('sectiondesc');
                    ...
                    var section_description = $(this).find('.txtip').data('section_description');
        ...
        faqTemplate: function (val,section_description,sectionlimit, extra_class, template, edit, startdate,enddate,faqcat) {
            ...
            if (edit == 'N') {
                ...
                section += '<input id="' + iCount + '" data-class="' + extra_class + '" data-type="' + template + '"  data-section_description="' + section_description + '" data-slimit="' + sectionlimit + '" data-faqcat="' + faqcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                ...
                section += '<input id="' + edit + '" data-class="' + extra_class + '" data-type="' + template + '" data-section_description="' + section_description + '" data-slimit="' + sectionlimit + '" data-faqcat="' + faqcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
        ...
        popularTemplate: function (val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout,extra_class,startdate,enddate,blogscat) {
            ...
            if (edit == 'N') {
                ...
                section += '<a href="javascript:;" data-filter="' + template + '" title="Edit" data-id="' + iCount + '" class="popular-template">';
                ...
                section += '<div class="defoult-module section-item popularTemplate" data-editor="' + iCount + '">';
...
//                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
        ...
        addServiceblock: function (imgsrc, val, imgCaption, content, type, edit,folderid, title, sub_title, shortdescription, buttontitle, buttonlink) {
            ...
            if ($('.add-element').hasClass('clicked')) {
                ...
                section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-shortdescription="' + shortdescription + '" data-title="' + title + '" data-sub_title="' + sub_title + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip imgcontentclass" value="' + content1 + '"/>';
                ...
                $('.add-element.clicked').parents('.col_1').find('.columnstwo').addClass('services-block');
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + iCount + '" class="services-block hideclass">';
                    ...
                    section += '<div class="section-item  services-img-rt-area" data-editor="' + iCount + '">';
                    ...
                    section += '<input id="' + iCount + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-shortdescription="' + shortdescription + '" data-title="' + title + '" data-sub_title="' + sub_title + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip" value="' + content1 + '"/>';
                    ...
                    section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-shortdescription="' + shortdescription + '" data-title="' + title + '" data-sub_title="' + sub_title + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip" value="' + content1 + '"/>';
        ...
        addGeneralContactInfo: function (imgsrc, val, imgCaption, content, type, edit,folderid, title2, buttontitle1, buttonlink1, title3, ph_no, ph_no2, title4, title5, buttontitle2, buttonlink2) {
            ...
            if ($('.add-element').hasClass('clicked')) {
                ...
                section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-title2="'+ title2 +'" data-buttontitle="'+ buttontitle1 +'" data-buttonlink="'+ buttonlink1 +'" data-title3="'+ title3 +'" data-ph_no="'+ ph_no +'" data-ph_no2="'+ ph_no2 +'" data-title4="' + title4 + '" data-title5="'+ title5 +'" data-buttontitle2="'+ buttontitle2 +'" data-buttonlink2="'+ buttonlink2 +'"  type="hidden" class="imgip imgcontentclass" value="' + content1 + '"/>';
                ...
                $('.add-element.clicked').parents('.col_1').find('.columnstwo').addClass('contactinfo-block');
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + iCount + '" class="contactinfo-block hideclass">';
                    ...
                    section += '<div class="section-item  general-contact-info-img-rt-area" data-editor="' + iCount + '">';
        ...
        addSeparateBlock: function (imgsrc, val, imgCaption, content, type, edit,folderid, buttontitle, buttonlink) {
            ...
            if ($('.add-element').hasClass('clicked')) {
                ...
                section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip imgcontentclass" value="' + content1 + '"/>';
                ...
                $('.add-element.clicked').parents('.col_1').find('.columnstwo').addClass('separate-block');
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + iCount + '" class="separate-block hideclass">';
                    ...
                    section += '<div class="section-item  separate-img-rt-area" data-editor="' + iCount + '">';
                    ...
                    section += '<input id="' + iCount + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip" value="' + content1 + '"/>';
                    ...
                    section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip" value="' + content1 + '"/>';
        ...
        addAddOnBlock: function (imgsrc, val, imgCaption, content, type, edit,folderid, buttontitle, buttonlink) {
            ...
            if ($('.add-element').hasClass('clicked')) {
                ...
                $('.add-element.clicked').parents('.col_1').find('.columnstwo').addClass('add-on-block');
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + iCount + '" class="add-on-block hideclass">';
                    ...
                    section += '<div class="section-item  add-on-img-rt-area" data-editor="' + iCount + '">';
        ...
        addHomeImageWithContent: function (imgsrc, val, imgCaption, content, type, edit,folderid, title_client, client_counter, sub_title) {
...
//                section += '<img src="' + imgsrc + '">';
                ...
                section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-title_client="' + title_client + '" data-sub_title="' + sub_title + '" data-client_counter="' + client_counter + '" data-caption="' + imgCaption + '" data-folderid="'+folderid+'" type="hidden" class="imgip homeimagecontclass" value="' + content1 + '"/>';
...
//                    section += '<img src="' + imgsrc + '">';
                    ...
                    section += '<input id="' + iCount + '" data-id="' + val + '" data-type="' + type + '" data-title_client="' + title_client + '" data-sub_title="' + sub_title + '" data-client_counter="' + client_counter + '" data-caption="' + imgCaption + '" data-folderid="'+folderid+'" type="hidden" class="imgip" value="' + content1 + '"/>';
...
//                    section += '<img src="' + imgsrc + '">';
                    ...
                    section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-title_client="' + title_client + '" data-sub_title="' + sub_title + '" data-client_counter="' + client_counter + '" data-caption="' + imgCaption + '" data-folderid="'+folderid+'" type="hidden" class="imgip" value="' + content1 + '"/>';
...
//                    }
        ...
        moduleSectionsFeatureBlogs: function (caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType,extraclass) {
            ...
            if (edit == 'N') {
                ...
                section += '<a href="javascript:;" data-filter="' + template + '" title="Edit" data-id="' + iCount + '" class="featureblogs-module">';
                ...
                section += '<a data-id="' + iCount + '" data-filter="' + template + '" title="Add more" class="add-link featureblogs-module" href="javascript:;">';
                ...
                section += '<input id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="featureblogs" />';
                ...
                section += '<a data-id="' + edit + '" data-filter="' + template + '" title="Add more" class="add-link featureblogs-module" href="javascript:;">';
                ...
                section += '<input id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="featureblogs" />';
        ...
        moduleSectionsFaqs: function (caption,section_description,recids, recTitle, edit, template,extraclass) {
            ...
            if (edit == 'N') {
                ...
                section += '<a href="javascript:;" title="Edit" data-filter="' + template + '" data-section_description="' + section_description + '" data-extraclass="' + extraclass + '" data-id="' + iCount + '" class="faqs-module">';
                ...
                section += '<a data-id="' + iCount + '" data-filter="' + template + '" data-section_description="' + section_description + '" data-extraclass="' + extraclass + '" title="Add more" class="add-link faqs-module" href="javascript:;">';
                ...
                section += '<input id="' + iCount + '" type="hidden" data-filter="' + template + '" data-section_description="' + section_description + '" data-extraclass="' + extraclass + '" data-caption="' + caption + '"  data-type="module" value="faqs" />';
                ...
                section += '<a data-id="' + edit + '" data-filter="' + template + '" data-section_description="' + section_description + '" data-extraclass="' + extraclass + '" title="Add more" class="add-link faqs-module" href="javascript:;">';
                ...
                section += '<input id="' + edit + '" type="hidden" data-filter="' + template + '" data-section_description="' + section_description + '" data-extraclass="' + extraclass + '" data-caption="' + caption + '" data-type="module" value="faqs" />';
        ...
        submitFrmSectionPopularModuleTemplate: function () {

            if ($('#frmSectionPopularModuleTemplate').validate().form()) {

                var edit = $('#frmSectionPopularModuleTemplate input[name=editing]').val() != '' ? $('#frmSectionPopularModuleTemplate input[name=editing]').val() : 'N';

                $('#no-content').addClass('hide');

                $('#has-content').removeClass('hide');

                var val = $('#frmSectionPopularModuleTemplate input[name=section_title]').val();

                var sectionlimit = $('#frmSectionPopularModuleTemplate input[name=section_limit]').val();

                var sectiondesc = $('#frmSectionPopularModuleTemplate textarea[name=section_description]').val();

                var template = $('#frmSectionPopularModuleTemplate input[name=template]').val();

                var config = $('#frmSectionPopularModuleTemplate select[name=section_config]').val();

                var configTxt = $('#frmSectionPopularModuleTemplate #config option:selected').text();

                var extra_class = $('#frmSectionPopularModuleTemplate input[name=extra_class]').val();

                var startdate = $('#frmSectionPopularModuleTemplate input[name=blogs_start_date_time]').val();

                var enddate = $('#frmSectionPopularModuleTemplate input[name=blogs_end_date_time]').val();

                var blogscat = $('#frmSectionPopularModuleTemplate select[name=blogscat]').val();

                var layout = $('#frmSectionPopularModuleTemplate select[name=layoutType]').val();

                builder.popularTemplate(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout,extra_class,startdate,enddate,blogscat);

                $('#sectionPopularModuleTemplate').modal('hide');
        ...
        submitFrmSectionFaqsModuleTemplate: function () {
            ...
            if ($('#frmSectionFaqsModuleTemplate').validate().form()) {
                ...
                var section_description = $('#frmSectionFaqsModuleTemplate textarea[name=section_description]').val();
                ...
                builder.faqTemplate(val,section_description, sectionlimit, extra_class, template, edit, startdate,enddate,faqcat);
        ...
        submitFrmSectionServiceblock: function () {

            if ($('#frmSectionServiceblock').validate().form()) {

                var edit = $('#frmSectionServiceblock input[name=editing]').val() != '' ? $('#frmSectionServiceblock input[name=editing]').val() : 'N';

                $('#no-content').addClass('hide');

                $('#has-content').removeClass('hide');

                var folderid = $('#frmSectionServiceblock').find('.folder_1').val();

                var val = $('#frmSectionServiceblock').find('.imgip').val();

                var imgCaption = $('#frmSectionServiceblock #img_title').val();

                var imgsrc = $('#frmSectionServiceblock').find('.thumbnail img').attr('src');

                var content = sectionServiceblockCk.getData();

                var type = $('#frmSectionServiceblock input[name=selector]:checked').val();

        

                var title = $('#frmSectionServiceblock #title').val();

                var sub_title = $('#frmSectionServiceblock #sub_title').val();

                var shortdescription = $('#frmSectionServiceblock #shortdescription').val();

                var buttontitle = $('#frmSectionServiceblock #buttontitle').val();

                var buttonlink = $('#frmSectionServiceblock #buttonlink').val();

        

                builder.addServiceblock(imgsrc, val, imgCaption, content, type, edit,folderid, title, sub_title, shortdescription, buttontitle, buttonlink);

                builder.reInitSortable();

                $('#sectionServiceblock').modal('hide');

            }

        },

        submitFrmSectionGeneralContactInfo: function () {

            if ($('#frmSectionGeneralContactInfo').validate().form()) {

                var edit = $('#frmSectionGeneralContactInfo input[name=editing]').val() != '' ? $('#frmSectionGeneralContactInfo input[name=editing]').val() : 'N';

                $('#no-content').addClass('hide');

                $('#has-content').removeClass('hide');

                var folderid = $('#frmSectionGeneralContactInfo').find('.folder_1').val();

                var val = $('#frmSectionGeneralContactInfo').find('.imgip').val();

                var imgsrc = $('#frmSectionGeneralContactInfo').find('.thumbnail img').attr('src');

                var content = sectionGeneralContactInfoCk.getData();

                var type = $('#frmSectionGeneralContactInfo input[name=selector]:checked').val();

                

                var imgCaption = $('#frmSectionGeneralContactInfo #img_title').val();

                var title2 = $('#frmSectionGeneralContactInfo #title2').val();

                var buttontitle1 = $('#frmSectionGeneralContactInfo #buttontitle').val();

                var buttonlink1 = $('#frmSectionGeneralContactInfo #buttonlink').val();

        

                var title3 = $('#frmSectionGeneralContactInfo #title3').val();

                var ph_no = $('#frmSectionGeneralContactInfo #ph_no').val();

                var ph_no2 = $('#frmSectionGeneralContactInfo #ph_no2').val();

        

                var title4 = $('#frmSectionGeneralContactInfo #title4').val();

                var title5 = $('#frmSectionGeneralContactInfo #title5').val();

                var buttontitle2 = $('#frmSectionGeneralContactInfo #buttontitle2').val();

                var buttonlink2 = $('#frmSectionGeneralContactInfo #buttonlink2').val();

        

                builder.addGeneralContactInfo(imgsrc, val, imgCaption, content, type, edit,folderid, title2, buttontitle1, buttonlink1, title3, ph_no, ph_no2, title4, title5, buttontitle2, buttonlink2);

                builder.reInitSortable();

                $('#sectionGeneralContactInfo').modal('hide');

            }

        },

        submitFrmSectionSeparateBlock: function () {

            if ($('#frmSectionSeparateBlock').validate().form()) {

                var edit = $('#frmSectionSeparateBlock input[name=editing]').val() != '' ? $('#frmSectionSeparateBlock input[name=editing]').val() : 'N';

                $('#no-content').addClass('hide');

                $('#has-content').removeClass('hide');

                var folderid = $('#frmSectionSeparateBlock').find('.folder_1').val();

                var val = $('#frmSectionSeparateBlock').find('.imgip').val();

                var imgCaption = $('#frmSectionSeparateBlock #img_title').val();

                var imgsrc = $('#frmSectionSeparateBlock').find('.thumbnail img').attr('src');

                var content = sectionSeparateBlockCk.getData();

                var type = $('#frmSectionSeparateBlock input[name=selector]:checked').val();

                var buttontitle = $('#frmSectionSeparateBlock #buttontitle').val();

                var buttonlink = $('#frmSectionSeparateBlock #buttonlink').val();

                builder.addSeparateBlock(imgsrc, val, imgCaption, content, type, edit,folderid, buttontitle, buttonlink);

                builder.reInitSortable();

                $('#sectionSeparateBlock').modal('hide');

            }

        },

        submitFrmSectionAddOnBlock: function () {

            if ($('#frmSectionAddOnBlock').validate().form()) {

                var edit = $('#frmSectionAddOnBlock input[name=editing]').val() != '' ? $('#frmSectionAddOnBlock input[name=editing]').val() : 'N';

                $('#no-content').addClass('hide');

                $('#has-content').removeClass('hide');

                var folderid = $('#frmSectionAddOnBlock').find('.folder_1').val();

                var val = $('#frmSectionAddOnBlock').find('.imgip').val();

                var imgCaption = $('#frmSectionAddOnBlock #img_title').val();

                var imgsrc = $('#frmSectionAddOnBlock').find('.thumbnail img').attr('src');

                var content = sectionAddOnBlockCk.getData();

                var type = $('#frmSectionAddOnBlock input[name=selector]:checked').val();

                var buttontitle = $('#frmSectionAddOnBlock #buttontitle').val();

                var buttonlink = $('#frmSectionAddOnBlock #buttonlink').val();

                builder.addAddOnBlock(imgsrc, val, imgCaption, content, type, edit,folderid, buttontitle, buttonlink);

                builder.reInitSortable();

                $('#sectionAddOnBlock').modal('hide');
        ...
        submitFrmSectionHomeImage: function () {
            ...
            if ($('#frmSectionHomeImage').validate().form()) {
                ...
                var title_client = $('#frmSectionHomeImage #title_client').val();

                var client_counter = $('#frmSectionHomeImage #client_counter').val();

                var sub_title = $('#frmSectionHomeImage #sub_title').val();

                builder.addHomeImageWithContent(imgsrc, val, imgCaption, content, type, edit,folderid, title_client, client_counter, sub_title);
        ...
        submitFrmSectionFeatureBlogsModule: function () {

            if ($('#frmSectionFeatureBlogsModule').validate().form()) {

                var edit = $('#frmSectionFeatureBlogsModule input[name=editing]').val() != '' ? $('#frmSectionFeatureBlogsModule input[name=editing]').val() : 'N';

                $('#no-content').addClass('hide');

                $('#has-content').removeClass('hide');

                var template = $('#frmSectionFeatureBlogsModule input[name=template]').val();

                var imgCaption = $('#frmSectionFeatureBlogsModule #section_title').val();

                var desc = $('#frmSectionFeatureBlogsModule #section_description').val();

                var config = $('#frmSectionFeatureBlogsModule #config').val();

                 var extraclass = $('#frmSectionFeatureBlogsModule #extra_class').val();

                var configTxt = $('#frmSectionFeatureBlogsModule #config option:selected').text();

                var layoutType = $('#frmSectionFeatureBlogsModule select[name=layoutType]').val();

                var recids = [];

                var recTitle = [];

                $('#sectionFeatureBlogsModule #datatable_blogs_ajax .chkChoose:checked').each(function () {
                ...
                builder.moduleSectionsFeatureBlogs(imgCaption, desc, config, configTxt, recids, recTitle, edit, template, layoutType,extraclass);

                builder.reInitSortable();

                $('#sectionFeatureBlogsModule').modal('hide');
        ...
        submitFrmSectionFaqsModule: function () {
            ...
            if ($('#frmSectionFaqsModule').validate().form()) {
                ...
                var section_description = $('#frmSectionFaqsModule #section_description').val();
                ...
                builder.moduleSectionsFaqs(imgCaption,section_description,recids, recTitle, edit, template,extraclass);
...
ClassicEditor.create(document.querySelector('#txtDetailDescription'), cmsConfig)
...
$(document).on('click', '.services-block', function (event) {

    $('#pgBuiderSections').modal('hide');

    $('#sectionServiceblock').modal({
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .imgcontentclass').length == 1) {
        ...
        var title = colData.data('title');

        var sub_title = colData.data('sub_title');

        var shortdescription = colData.data('shortdescription');
        ...
        $('#sectionServiceblock .imgip').val(img);

        $('#sectionServiceblock img:first').attr('src', src);

        $('#sectionServiceblock #img_title').val(caption);

        $('#sectionServiceblock #vfolder_id').val(folderid);

        $('#sectionServiceblock textarea').val(content);

        $('#sectionServiceblock input[value="' + align + '"]').prop('checked', true);



        $('#sectionServiceblock #shortdescription').val(shortdescription);

        $('#sectionServiceblock #title').val(title);

        $('#sectionServiceblock #sub_title').val(sub_title);

        $('#sectionServiceblock #buttontitle').val(buttontitle);

        $('#sectionServiceblock #buttonlink').val(buttonlink);



        $('#sectionServiceblock #addSection').text('Update');

        $('#sectionServiceblock #exampleModalLabel b').text('Edit Services Block');
...

    {
        ...
        if ($('.services-img-rt-area #' + id).data('folderid') != '' && typeof $('.services-img-rt-area #' + id).data('folderid') != 'undefined') {     

            var folderid = $('.services-img-rt-area #' + id).data('folderid');     
        ...
        var img = $('.services-img-rt-area #' + id).data('id');

        var caption = $('.services-img-rt-area #' + id).data('caption');

        var align = $('.services-img-rt-area #' + id).data('type');

        var content = $('.services-img-rt-area #' + id).val();

        var src = $('.services-img-rt-area .' + id).attr('src');



        var title = $('.services-img-rt-area #' + id).data('title');

        var sub_title = $('.services-img-rt-area #' + id).data('sub_title');

        var shortdescription = $('.services-img-rt-area #' + id).data('shortdescription');

        var buttontitle = $('.services-img-rt-area #' + id).data('buttontitle');

        var buttonlink = $('.services-img-rt-area #' + id).data('buttonlink');



        $('#sectionServiceblock input[name=editing]').val(id);
        ...
        $('#sectionServiceblock input[name=editing]').val('');

        $('#sectionServiceblock .imgip').val('');

        $('#sectionServiceblock img:first').attr('src', site_url + '/assets/images/packages/visualcomposer/plus-no-image.png');

        $('#sectionServiceblock #img_title').val('');

        $('#sectionServiceblock textarea').val('');

        $('#sectionServiceblock input:checked').prop('checked', false);



        $('#sectionServiceblock #shortdescription').val('');

        $('#sectionServiceblock #title').val('');

        $('#sectionServiceblock #sub_title').val('');

        $('#sectionServiceblock #buttontitle').val('');

        $('#sectionServiceblock #buttonlink').val('');



        $('#sectionServiceblock #addSection').text('Add');

        $('#sectionServiceblock #exampleModalLabel b').text('Services Block');
    ...
    $('#sectionServiceblock .ck-editor').remove();



    ClassicEditor.create(document.querySelector('#sectionServiceblock #ck-area'), cmsConfig)

            .then(editor => {

                window.sectionServiceblockCk = editor;
...
$('#sectionServiceblock').on('shown.bs.modal', function () {

    builder.resizeImageContentModal();

    validateSectionServiceblock.init();

}).on('hidden.bs.modal', function () {

    validateSectionServiceblock.reset();

});



$(document).on('click', '.contactinfo-block', function (event) {

    $('#pgBuiderSections').modal('hide');

    $('#sectionGeneralContactInfo').modal({
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .imgcontentclass').length == 1) {
        ...
        var title2 = colData.data('title2');
        ...
        var title3 = colData.data('title3');

        var ph_no = colData.data('ph_no');

        var ph_no2 = colData.data('ph_no2');



        var title4 = colData.data('title4');

        var title5 = colData.data('title5');

        var buttontitle2 = colData.data('buttontitle2');

        var buttonlink2 = colData.data('buttonlink2');
        ...
        $('#sectionGeneralContactInfo .imgip').val(img);

        $('#sectionGeneralContactInfo img:first').attr('src', src);

        $('#sectionGeneralContactInfo #img_title').val(caption);

        $('#sectionGeneralContactInfo #vfolder_id').val(folderid);

        $('#sectionGeneralContactInfo textarea').val(content);

        $('#sectionGeneralContactInfo input[value="' + align + '"]').prop('checked', true);



        $('#sectionGeneralContactInfo #shortdescription').val(shortdescription);

        $('#sectionGeneralContactInfo #title').val(title);

        $('#sectionGeneralContactInfo #title2').val(title2);

        $('#sectionGeneralContactInfo #buttontitle').val(buttontitle);

        $('#sectionGeneralContactInfo #buttonlink').val(buttonlink);



        $('#sectionGeneralContactInfo #title3').val(title3);

        $('#sectionGeneralContactInfo #ph_no').val(ph_no);

        $('#sectionGeneralContactInfo #ph_no2').val(ph_no2);



        $('#sectionGeneralContactInfo #title4').val(title4);

        $('#sectionGeneralContactInfo #title5').val(title5);

        $('#sectionGeneralContactInfo #buttontitle2').val(buttontitle2);

        $('#sectionGeneralContactInfo #buttonlink2').val(buttonlink2);



        $('#sectionGeneralContactInfo #addSection').text('Update');

        $('#sectionGeneralContactInfo #exampleModalLabel b').text('Edit General Contact Info');
        ...
        $('#sectionGeneralContactInfo #sub_title').val(sub_title);
...

    {
        ...
        if ($('.general-contact-info-img-rt-area #' + id).data('folderid') != '' && typeof $('.general-contact-info-img-rt-area #' + id).data('folderid') != 'undefined') {     

            var folderid = $('.general-contact-info-img-rt-area #' + id).data('folderid');     
        ...
        var img = $('.general-contact-info-img-rt-area #' + id).data('id');

        var align = $('.general-contact-info-img-rt-area #' + id).data('type');

        var content = $('.general-contact-info-img-rt-area #' + id).val();

        var src = $('.general-contact-info-img-rt-area .' + id).attr('src');

        

        // var title = $('.general-contact-info-img-rt-area #' + id).data('title');

        // var sub_title = $('.general-contact-info-img-rt-area #' + id).data('sub_title');

        // var shortdescription = $('.general-contact-info-img-rt-area #' + id).data('shortdescription');

        // var buttontitle = $('.general-contact-info-img-rt-area #' + id).data('buttontitle');

        // var buttonlink = $('.general-contact-info-img-rt-area #' + id).data('buttonlink');

        

        var caption = $('.general-contact-info-img-rt-area #' + id).data('caption');

        var title2 = $('.general-contact-info-img-rt-area #' + id).data('title2');
        ...
        var title3 = $('.general-contact-info-img-rt-area #' + id).data('title3');

        var ph_no = $('.general-contact-info-img-rt-area #' + id).data('ph_no');

        var ph_no2 = $('.general-contact-info-img-rt-area #' + id).data('ph_no2');



        var title4 = $('.general-contact-info-img-rt-area #' + id).data('title4');

        var title5 = $('.general-contact-info-img-rt-area #' + id).data('title5');

        var buttontitle2 = $('.general-contact-info-img-rt-area #' + id).data('buttontitle2');

        var buttonlink2 = $('.general-contact-info-img-rt-area #' + id).data('buttonlink2');





        $('#sectionGeneralContactInfo input[name=editing]').val(id);
        ...
        $('#sectionGeneralContactInfo input[name=editing]').val('');

        $('#sectionGeneralContactInfo .imgip').val('');

        $('#sectionGeneralContactInfo img:first').attr('src', site_url + '/assets/images/packages/visualcomposer/plus-no-image.png');

        $('#sectionGeneralContactInfo #img_title').val('');

        $('#sectionGeneralContactInfo textarea').val('');

        $('#sectionGeneralContactInfo input:checked').prop('checked', false);



        $('#sectionGeneralContactInfo #shortdescription').val('');

        $('#sectionGeneralContactInfo #title').val('');

        $('#sectionGeneralContactInfo #sub_title').val('');

        $('#sectionGeneralContactInfo #buttontitle').val('');

        $('#sectionGeneralContactInfo #buttonlink').val('');



        $('#sectionGeneralContactInfo #title').val();

        $('#sectionGeneralContactInfo #title2').val();
        ...
        $('#sectionGeneralContactInfo #title3').val();

        $('#sectionGeneralContactInfo #ph_no').val();

        $('#sectionGeneralContactInfo #ph_no2').val();



        $('#sectionGeneralContactInfo #title4').val();

        $('#sectionGeneralContactInfo #title5').val();

        $('#sectionGeneralContactInfo #buttontitle2').val();

        $('#sectionGeneralContactInfo #buttonlink2').val();



        $('#sectionGeneralContactInfo #addSection').text('Add');

        $('#sectionGeneralContactInfo #exampleModalLabel b').text('General Contact Info');
    ...
    $('#sectionGeneralContactInfo .ck-editor').remove();



    ClassicEditor.create(document.querySelector('#sectionGeneralContactInfo #ck-area'), cmsConfig)

            .then(editor => {

                window.sectionGeneralContactInfoCk = editor;
...
$('#sectionGeneralContactInfo').on('shown.bs.modal', function () {

    builder.resizeImageContentModal();

    validateSectionGeneralContactInfo.init();

}).on('hidden.bs.modal', function () {

    validateSectionGeneralContactInfo.reset();

});



$(document).on('click', '.separate-block', function (event) {

    

    $('#pgBuiderSections').modal('hide');

    $('#sectionSeparateBlock').modal({
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .imgcontentclass').length == 1) {
        ...
        $('#sectionSeparateBlock .imgip').val(img);

        $('#sectionSeparateBlock img:first').attr('src', src);

        $('#sectionSeparateBlock #img_title').val(caption);

        $('#sectionSeparateBlock #vfolder_id').val(folderid);

        $('#sectionSeparateBlock textarea').val(content);

        $('#sectionSeparateBlock input[value="' + align + '"]').prop('checked', true);

        $('#sectionSeparateBlock #addSection').text('Update');

        $('#sectionSeparateBlock #exampleModalLabel b').text('Edit Separate Block');

        $('#sectionSeparateBlock #buttontitle').val(buttontitle);

        $('#sectionSeparateBlock #buttonlink').val(buttonlink);
...

    {
        ...
        if ($('.separate-img-rt-area #' + id).data('folderid') != '' && typeof $('.separate-img-rt-area #' + id).data('folderid') != 'undefined') {     

            var folderid = $('.separate-img-rt-area #' + id).data('folderid');     
        ...
        var img = $('.separate-img-rt-area #' + id).data('id');

        var caption = $('.separate-img-rt-area #' + id).data('caption');

        var align = $('.separate-img-rt-area #' + id).data('type');

        var content = $('.separate-img-rt-area #' + id).val();

        var src = $('.separate-img-rt-area .' + id).attr('src');

        var buttontitle = $('.separate-img-rt-area #' + id).data('buttontitle');

        var buttonlink = $('.separate-img-rt-area #' + id).data('buttonlink');



        $('#sectionSeparateBlock input[name=editing]').val(id);
        ...
        $('#sectionSeparateBlock input[name=editing]').val('');

        $('#sectionSeparateBlock .imgip').val('');

        $('#sectionSeparateBlock img:first').attr('src', site_url + '/assets/images/packages/visualcomposer/plus-no-image.png');

        $('#sectionSeparateBlock #img_title').val('');

        $('#sectionSeparateBlock textarea').val('');

        $('#sectionSeparateBlock input:checked').prop('checked', false);

        $('#sectionSeparateBlock #addSection').text('Add');

        $('#sectionSeparateBlock #exampleModalLabel b').text('Separate Block');

        $('#sectionSeparateBlock #buttontitle').val('');

        $('#sectionSeparateBlock #buttonlink').val('');

    }



    $('#sectionSeparateBlock .ck-editor').remove();



    ClassicEditor.create(document.querySelector('#sectionSeparateBlock #ck-area'), cmsConfig)

            .then(editor => {

                window.sectionSeparateBlockCk = editor;
...
$('#sectionSeparateBlock').on('shown.bs.modal', function () {

    builder.resizeImageContentModal();

    validateSectionSeparateBlock.init();

}).on('hidden.bs.modal', function () {

    validateSectionSeparateBlock.reset();

});



$(document).on('click', '.add-on-block', function (event) {

    

    $('#pgBuiderSections').modal('hide');

    $('#sectionAddOnBlock').modal({
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .imgcontentclass').length == 1) {
        ...
        $('#sectionAddOnBlock .imgip').val(img);

        $('#sectionAddOnBlock img:first').attr('src', src);

        $('#sectionAddOnBlock #img_title').val(caption);

        $('#sectionAddOnBlock #vfolder_id').val(folderid);

        $('#sectionAddOnBlock textarea').val(content);

        $('#sectionAddOnBlock input[value="' + align + '"]').prop('checked', true);

        $('#sectionAddOnBlock #addSection').text('Update');

        $('#sectionAddOnBlock #exampleModalLabel b').text('Edit Add On Block');

        $('#sectionAddOnBlock #buttontitle').val(buttontitle);

        $('#sectionAddOnBlock #buttonlink').val(buttonlink);
...

    {
        ...
        if ($('.add-on-img-rt-area #' + id).data('folderid') != '' && typeof $('.add-on-img-rt-area #' + id).data('folderid') != 'undefined') {     

            var folderid = $('.add-on-img-rt-area #' + id).data('folderid');     
        ...
        var img = $('.add-on-img-rt-area #' + id).data('id');

        var caption = $('.add-on-img-rt-area #' + id).data('caption');

        var align = $('.add-on-img-rt-area #' + id).data('type');

        var content = $('.add-on-img-rt-area #' + id).val();

        var src = $('.add-on-img-rt-area .' + id).attr('src');

        var buttontitle = $('.add-on-img-rt-area #' + id).data('buttontitle');

        var buttonlink = $('.add-on-img-rt-area #' + id).data('buttonlink');



        $('#sectionAddOnBlock input[name=editing]').val(id);
        ...
        $('#sectionAddOnBlock input[name=editing]').val('');

        $('#sectionAddOnBlock .imgip').val('');

        $('#sectionAddOnBlock img:first').attr('src', site_url + '/assets/images/packages/visualcomposer/plus-no-image.png');

        $('#sectionAddOnBlock #img_title').val('');

        $('#sectionAddOnBlock textarea').val('');

        $('#sectionAddOnBlock input:checked').prop('checked', false);

        $('#sectionAddOnBlock #addSection').text('Add');

        $('#sectionAddOnBlock #exampleModalLabel b').text('Add On Block');

        $('#sectionAddOnBlock #buttontitle').val('');

        $('#sectionAddOnBlock #buttonlink').val('');

    }



    $('#sectionAddOnBlock .ck-editor').remove();



    ClassicEditor.create(document.querySelector('#sectionAddOnBlock #ck-area'), cmsConfig)

            .then(editor => {

                window.sectionAddOnBlockCk = editor;
...
$('#sectionAddOnBlock').on('shown.bs.modal', function () {

    builder.resizeImageContentModal();

    validateSectionAddOnBlock.init();

}).on('hidden.bs.modal', function () {

    validateSectionAddOnBlock.reset();
...
$(document).on('click', '.home-information', function (event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .homeimagecontclass').length == 1) {
        ...
        var title_client = colData.data('title_client');

        var client_counter = colData.data('client_counter');
        ...
        $('#sectionHomeImage #title_client').val(title_client);

        $('#sectionHomeImage #client_counter').val(client_counter);

        $('#sectionHomeImage #sub_title').val(sub_title);

        $('#sectionHomeImage input[value="' + align + '"]').prop('checked', true);

        $('#sectionHomeImage #addSection').text('Update');

        $('#sectionHomeImage #exampleModalLabel b').text('Edit Home Page Section');
        ...
        var title_client = $('.home-img-rt-area #' + id).data('title_client');

        var client_counter = $('.home-img-rt-area #' + id).data('client_counter');

        var sub_title = $('.home-img-rt-area #' + id).data('sub_title');
        ...
        $('#sectionHomeImage #title_client').val('');

        $('#sectionHomeImage #client_counter').val('');

        $('#sectionHomeImage #sub_title').val('');

        $('#sectionHomeImage input:checked').prop('checked', false);

        $('#sectionHomeImage #addSection').text('Add');

        $('#sectionHomeImage #exampleModalLabel b').text('Home Page Section');
...
$(document).on('click', '.popular-template', function (event) {

    $('#pgBuiderSections').modal('hide');

    $('#sectionPopularModuleTemplate').modal({
     ...
     jQuery.ajax({
        ...
        success: function (result) {
            ...
            $('#sectionPopularModuleTemplate #cat-template-layout').html(result);
...

    {
        ...
        $('#sectionPopularModuleTemplate input[name=editing]').val(id);

        $('#sectionPopularModuleTemplate #section_title').val($.trim(value));

        $('#sectionPopularModuleTemplate #section_limit').val($.trim(slimit));

        $('#sectionPopularModuleTemplate #section_description').val(sdesc);

        $('#sectionPopularModuleTemplate select[name=layoutType] option[value=' + layout + ']').prop('selected', true);

        $('#sectionPopularModuleTemplate select[name=section_config] option[value=' + config + ']').prop('selected', true);

        $('#sectionPopularModuleTemplate #extra_class').val(extclass);

        if(blogscat != ''){

            $('#sectionPopularModuleTemplate select[name=blogscat] option[value=' + blogscat + ']').prop('selected', true);

        }

        $('#sectionPopularModuleTemplate #blogs_start_date_time').val(startdate);

        $('#sectionPopularModuleTemplate #blogs_end_date_time').val(enddate);

        $('#sectionPopularModuleTemplate #addSection').text('Update');

        $('#sectionPopularModuleTemplate #exampleModalLabel b').text('Edit Popular');

    } else {

        var value = $(this).text();

        $('#sectionPopularModuleTemplate input[name=editing]').val('');

        $('#sectionPopularModuleTemplate #section_title').val($.trim(value));

        $('#sectionPopularModuleTemplate select[name=layoutType] option:first').prop('selected', true);

        $('#sectionPopularModuleTemplate #extra_class').val(extclass);

        $('#sectionPopularModuleTemplate select[name=blogscat] option:first').prop('selected', true);

        $('#sectionPopularModuleTemplate #blogs_start_date_time').val(startdate);

        $('#sectionPopularModuleTemplate #blogs_end_date_time').val(enddate);

        $('#sectionPopularModuleTemplate #addSection').text('Add');

        $('#sectionPopularModuleTemplate #exampleModalLabel b').text('Add Popular');

    }

     $('#sectionPopularModuleTemplate #blogs_start_date_time').datetimepicker({
    ...
    $('#sectionPopularModuleTemplate #blogs_end_date_time').datetimepicker({
        ...
        onShow: function (ct) {
            ...
            this.setOptions({
                ...
                minDate: jQuery('#sectionPopularModuleTemplate #blogs_start_date_time').val() ? jQuery('#sectionPopularModuleTemplate #blogs_start_date_time').val() : false
    ...
    $('#sectionPopularModuleTemplate input[name=template]').val($(this).data('filter'));

});



$('#sectionPopularModuleTemplate').on('shown.bs.modal', function () {

    $('#sectionPopularModuleTemplate select').selectpicker();

    validatePopularTemplate.init();

}).on('hidden.bs.modal', function () {

    $('#sectionPopularModuleTemplate select').selectpicker('destroy');

    validatePopularTemplate.reset();
...
$(document).on('click', '.photoalbum-template', function (event) {
...

    {
        ...
        $('#sectionPhotoAlbumModuleTemplate #exampleModalLabel b').text('Edit Our Project');
        ...
        $('#sectionPhotoAlbumModuleTemplate #exampleModalLabel b').text('Add Our Project');
...
var validateSectionServiceblock = function () {

    var handleSectionServiceblock = function () {

        $("#frmSectionServiceblock").validate({
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionServiceblock')).show();
            ...
            submitHandler: function (form) {
                ...
                builder.submitFrmSectionServiceblock();
        ...
        $('#frmSectionServiceblock #addSection').click(function () {

            sectionServiceblockCk.updateSourceElement();

        });



        $('#frmSectionServiceblock input').keypress(function (e) {
    ...
    return {
        ...
        init: function () {
            ...
            handleSectionServiceblock();

        },

        reset: function () {

            var validator = $("#frmSectionServiceblock").validate();
...
var validateSectionGeneralContactInfo = function () {

    var handleSectionGeneralContactInfo = function () {

        $("#frmSectionGeneralContactInfo").validate({
            ...
            messages: {
                ...
                buttontitle: {
                    ...
                    required: "Button title 1 is required.",
                ...
                title4: {
                    ...
                    required: "Title 4 is required.",

                },

                title5: {

                    required: "Title 5 is required.",

                },

                buttontitle2: {

                    required: "Button title 2 is required.",

                },

                buttonlink2: {

                    required: "Button link 2 is required.",
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionGeneralContactInfo')).show();
            ...
            submitHandler: function (form) {
                ...
                builder.submitFrmSectionGeneralContactInfo();
        ...
        $('#frmSectionGeneralContactInfo #addSection').click(function () {

            sectionGeneralContactInfoCk.updateSourceElement();

        });



        $('#frmSectionGeneralContactInfo input').keypress(function (e) {
    ...
    return {
        ...
        init: function () {
            ...
            handleSectionGeneralContactInfo();

        },

        reset: function () {

            var validator = $("#frmSectionGeneralContactInfo").validate();
...
var validateSectionSeparateBlock = function () {

    var handleSectionSeparateBlock = function () {

        $("#frmSectionSeparateBlock").validate({
...
//                    check_special_char: true, 
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionSeparateBlock')).show();
            ...
            submitHandler: function (form) {
                ...
                builder.submitFrmSectionSeparateBlock();
        ...
        $('#frmSectionSeparateBlock #addSection').click(function () {

            sectionSeparateBlockCk.updateSourceElement();

        });



        $('#frmSectionSeparateBlock input').keypress(function (e) {
    ...
    return {
        ...
        init: function () {
            ...
            handleSectionSeparateBlock();

        },

        reset: function () {

            var validator = $("#frmSectionSeparateBlock").validate();
...
var validateSectionAddOnBlock = function () {

    var handleSectionAddOnBlock = function () {

        $("#frmSectionAddOnBlock").validate({
...
//                    check_special_char: true,
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionAddOnBlock')).show();
            ...
            submitHandler: function (form) {
                ...
                builder.submitFrmSectionAddOnBlock();
        ...
        $('#frmSectionAddOnBlock #addSection').click(function () {

            sectionAddOnBlockCk.updateSourceElement();

        });



        $('#frmSectionAddOnBlock input').keypress(function (e) {
    ...
    return {
        ...
        init: function () {
            ...
            handleSectionAddOnBlock();

        },

        reset: function () {

            var validator = $("#frmSectionAddOnBlock").validate();
...
var validateSectionFeatureBlogs = function () {

    var handleSectionFeatureBlogs = function () {

        $("#frmSectionFeatureBlogsModule").validate({
                ...
                'delete[]': {
                    ...
                    required: {
                        ...
                        depends: function () {
                            ...
                            return $('#frmSectionFeatureBlogsModule input[name="editing"]').val().length == '';
            ...
            errorPlacement: function (error, element) {
                ...
                if (element.parent('.input-group').length) {
                    ...
                    error.insertBefore($('#frmSectionFeatureBlogsModule .table-container .table:first'));
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionFeatureBlogsModule')).show();
            ...
            submitHandler: function (form) {
                ...
                builder.submitFrmSectionFeatureBlogsModule();
        ...
        $('#frmSectionFeatureBlogsModule input').keypress(function (e) {
    ...
    return {
        ...
        init: function () {
            ...
            handleSectionFeatureBlogs();

        },

        reset: function () {

            var validator = $("#frmSectionFeatureBlogsModule").validate();
...
var validatePopularTemplate = function () {

    var handlePopularTemplate = function () {

        $("#frmSectionPopularModuleTemplate").validate({
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionPopularModuleTemplate')).show();
            ...
            submitHandler: function (form) {
                ...
                builder.submitFrmSectionPopularModuleTemplate();
        ...
        $('#frmSectionPopularModuleTemplate input').keypress(function (e) {
    ...
    return {
        ...
        init: function () {
            ...
            handlePopularTemplate();

        },

        reset: function () {

            var validator = $("#frmSectionPopularModuleTemplate").validate();
