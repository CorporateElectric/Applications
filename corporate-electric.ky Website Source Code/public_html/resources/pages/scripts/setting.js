    ...
    var handleSetting = function () {
        $('#frmSettings').validate({
            ...
            rules: {
                ...
                default_requestaquotation_email: {
                    required: true,
                    email: true,
                },
                default_requestaservice_email: {
                    required: true,
                    email: true,
                },
            ...
            messages: {
                ...
                default_contactus_email: {
                    required: "Default contact us email field is required.",
                },
                default_custom_email: {
                    required: "Default email field is required.",
                },
                default_requestaquotation_email: {
                    required: "Default request quotation email field is required.",
                },
                default_requestaservice_email: {
                    required: "Default request service visit email field is required.",
                },
                // default_getaestimate_email: {
    ...
    var handleSocialSetting = function() {
    		$('#frmSocial').validate({
    				...
    				messages: {
    						...
    						linkedin_link: {
                                                    // required: "Linkedin link field is required.",
                                                    url: Lang.get('validation.url', {
                                                                    attribute: Lang.get('template.settingModule.validUrl')
                                                    }),
    						},
    						...
    						youtube_link: {
                                                    // required: "Youtube link field is required.",
                                                    url: Lang.get('validation.url', {
                                                                    attribute: Lang.get('template.settingModule.validUrl')
                                                    }),
    						}
