...
! function(e) {
    ...
    ! function(e) {
        ...
        r.n(n).a.addLanguage("en-US", {
            ...
            getStarted: "Click a field from the right to this area",
            header: "Header",
            hide: "Edit",
            hidden: "Hidden Input",
            inline: "Inline",
        ...
        var i = {
                ...
                allowStageSort: !0,
                append: !1,
                controlOrder: ["header", "paragraph",  "hidden", "text","number", "textarea", "checkbox-group", "checkbox", "date", "file", "radio-group", "select","button" ],
        ...
        var n = {},
            o = {
                text: ["text", "password", "email", "color", "tel","alphabetic","alphanumeric"],
                header: ["h1", "h2", "h3"],
        ...
        o.a.register(["text", "file", "date", "number"], g), o.a.register(["text", "password", "email", "color", "tel","alphabetic","alphanumeric"], g, "text");
        var y = function(t) {
            var r, n;
        ...
        var v = function() {
                ...
                return r.startMoving = function(e, t) {
                    if(t.item.hasClass('input-control-18') == true){
                        setTimeout(function () {
                    ...
                    }else if(t.item.hasClass('input-control-19') == true){
                        setTimeout(function () {
                        $(".time_element").parents(".form-field").find(".subtype-wrap").hide();
                        $(".time_element").parents(".form-field").find(".maxlength-wrap").hide();
                        $(".time_element").parents(".form-field").find(".value-wrap").hide();
                     ...
                     else if(t.item.hasClass('input-control-16') == true){
                        setTimeout(function () {
                         $(".time_element").parents(".form-field").find(".subtype-wrap").hide();
                        $(".time_element").parents(".form-field").find(".maxlength-wrap").hide();
                        $(".time_element").parents(".form-field").find(".value-wrap").hide();
                     ...
                     else if(t.item.hasClass('input-control-15') == true){
                        setTimeout(function () {
                         $(".time_element").parents(".form-field").find(".subtype-wrap").hide();
                        $(".time_element").parents(".form-field").find(".maxlength-wrap").hide();
                        $(".time_element").parents(".form-field").find(".value-wrap").hide();
                    ...
                    }else if(t.item.hasClass('input-control-17') == true){
                        setTimeout(function () {
                        $(".time_element").parents(".form-field").find(".subtype-wrap").hide();
                        $(".time_element").parents(".form-field").find(".maxlength-wrap").hide();
                        $(".time_element").parents(".form-field").find(".value-wrap").hide();
                    ...
                    else if(t.item.hasClass('input-control-14') == true){
                        setTimeout(function () {
                        $(".time_element").parents(".form-field").find(".subtype-wrap").hide();
                        $(".time_element").parents(".form-field").find(".maxlength-wrap").hide();
                        $(".time_element").parents(".form-field").find(".value-wrap").hide();
                    ...
                    var a = [{
                        ...
                        events: {
                                click: function (e) {
                                	...
                                	$(".build_setting_acc").trigger('click');
                                    var formname = document.forms["frmfrombuilder"]["title"].value;
                                    var email = document.forms["frmfrombuilder"]["email"].value;
                                    var subject = document.forms["frmfrombuilder"]["admin_subject"].value;
                                    var content = document.forms["frmfrombuilder"]["admin_content"].value;
                                    var thankyoumsg = document.forms["frmfrombuilder"]["varThankYouMsg"].value;
                                    var user_subject = document.forms["frmfrombuilder"]["user_subject"].value;
                                    var user_content = document.forms["frmfrombuilder"]["user_content"].value;
                                    var chrDisplayUser = "N";
                                    ...
                                    if (thankyoumsg == "") {
                                        alert("Please enter thank you massage.");
                                        return false;
                                    ...
                                    if (subject == "") {
                                        alert("Please enter Admin Email Subject.");
                                        return false;
                                    }
                                    if (content == "") {
                                        alert("Please enter Admin Email Content.");
                                        return false;
                                    }
                                    if ($("#chrDisplayUser").is(":checked")) {
                                        chrDisplayUser = "Y"; 
                                       
                                         if (user_subject == "") {
                                            alert("Please enter User Email Subject.");
                                            return false;
                                        }
                                        else if (user_content == "") {
                                            alert("Please enter User Email Content.");
                                            return false;
                                        }
                                    }
                                    var URL = $(location).attr('href');
                                    var res = URL.split("/");
                                    if (formurl == 'edit?tab=P' || formurl == 'edit') {
                                        if (t.data.formData == '[]') {
                                            var descdata = $('#formdatadesc').val();
                                        } else {
                                            var descdata = t.data.formData;
                                        }
                                        var ajaxurl = window.site_url + '/powerpanel/formbuilder/updateformbuilderdata';
                                        $.ajax({
                                            url: ajaxurl,
                                            async: false,
                                            data: {
                                                ...
                                                formtitle1: '',
                                                formdesc: '',
                                                img_id: $('#frombuilder_image').val(),
                                                email: $('#email').val(),
                                                subject: $('#admin_subject').val(),
                                                content: $('#admin_content').val(),
                                                thankyoumsg: $('#varThankYouMsg').val(),
                                                user_subject: $('#user_subject').val(),
                                                user_content: $('#user_content').val(),
                                                check_user: chrDisplayUser,
                                                eid: formid,
                                                fromdata: descdata
                                            },
                                            type: "POST",
                                            success: function (data) {
                                                window.location.replace(window.site_url + '/powerpanel/formbuilder/');
                                            }
                                        });
                                    } else {
                                        var ajaxurl = window.site_url + '/powerpanel/formbuilder/formbuilderdata';
                                        $.ajax({
                                            url: ajaxurl,
                                            async: false,
                                            data: {
            ...
            y = (n(12), function() {
                ...
                return t.init = function() {
                    ...
                    return window.sessionStorage && (r.sortableControls ? t = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), t ? (t = window.JSON.parse(t), t = Object(p.A)(t.concat(e)), t =