...
/* Variable Declared S */
	var gulp				=	require('gulp'),
	    ...
	    sitePath			=	'C:/wamp64/www/corporate-electric/',
	    folder = {
	    	designHTML				: 	sitePath + 'public_html/',
	    	designHTMLPro			: 	sitePath + 'build/',

	        designSource 			: 	sitePath + 'public_html/assets/',
	        designSourcePro 		: 	sitePath + 'build/assets/',
	        
	        developmentMainUrl		: 	'http://localhost/corporate-electric/public_html',
	    },
	    productionmainUrl = {
		  	uri: 'http://localhost/corporate-electric/public_html',
		  	app: 'chrome'
		}
		uploadFolder = '';
/* Variable Declared E */
...
/* Gulpfile Development S */
	...
	/* SCSS Processing S */
		function scss() {
		    ...
		    return gulp.src(folder.designSource + 'main.scss')
		        ...
		        .pipe(notify({
		           	title: 'Gulp',
		           	subtitle: 'Success',
		           	message: 'Sass Task Successfully Run',
		           	sound: "Pop"
		       	}));
		}
	/* SCSS Processing E */
	...
	/* File Move S */
		function copy() {
	    	...
	    	gulp.src(folder.designSource + 'libraries/jquery/jquery.min.js')
	    		.pipe(gulp.dest(folder.designSource + 'js/'))

	    	return gulp.src(folder.designSource + 'libraries/OwlCarousel2-2.3.4/img/**/*')
	    		.pipe(gulp.dest(folder.designSource + 'images/'))

	    		.pipe(notify({
		           	title: 'Gulp',
		           	subtitle: 'Success',
		           	message: 'File Copy Task Successfully Run',
		           	sound: "Pop"
		       	}));
		}
	/* File Move E */
